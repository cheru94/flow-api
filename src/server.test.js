...
describe('Integration Test', () => {
    ...
    it('Location Endpoint Test', (done) => {
        request(server)
        .get('/v1/location')
        .end((err, response) => {
    ...
    it('Current Endpoint Test', (done) => {
       ...
       it('Current Endpoint Test with params', (done) => {
    ...
    it('Forecast Endpoint Test', (done) => {
        const param = 'city=Los Angeles, US';
        request(server)
    ...
    it('Forecast Endpoint Test with Params', (done) => {
        request(server)
        .get('/v1/forecast')     
        .end((err, response) => {
            expect(response).to.have.deep.property("statusCode");
